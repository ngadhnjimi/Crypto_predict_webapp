...
eth = HistoricalData(f"{cryptocurrency}-EUR", 60*60*24, '2017-01-01-00-00', '2023-03-27-00-00').retrieve_data()
...
# Remove any rows with NaN values from the test data
nan_indices = np.isnan(X_test).any(axis=1)
